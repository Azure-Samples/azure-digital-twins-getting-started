...
namespace BladeMR.ADT
{
    ...
    public class ADTRestClient
    {
        ...
        /// </summary>
        public TwinGameEvent OnADTReceivedTwinData;

        /// <summary>
        /// Event invoked when a digital twin property is updated on ADT.
        /// </summary>
        public TwinGameEvent OnUpdatedADTTwinProperty;
        ...
        /// <summary>
        /// Retrieves a twin's properties from the ADT service.
        /// </summary>
        /// <param name="twinId">The ID of the twin whose data is to be retrieved.</param>
        /// <returns>The properties of the twin as stored in ADT.</returns>
        public async Task GetTwinData(string twinId)
        {
            await Authenticate();
