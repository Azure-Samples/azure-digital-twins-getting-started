...
public class ProgressController : MonoBehaviour
{
    ...
    [SerializeField] private TelemetryRangeData telemetryRangeData;

    public TelemetryRangeData TelemetryRangeData
    {
        get => telemetryRangeData;
        set
        {
            telemetryRangeData = value;
            UpdateUI();
        }
    }
    ...
    private void UpdateUI()
    {
        ...
        textValue.text = Math.Round(currentValue, telemetryRangeData.displayRoundingPrecision).ToString(telemetryRangeData.format ?? "F");
